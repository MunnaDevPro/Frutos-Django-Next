...
export default function SettingsTab({ 
  ...
  return (
    <div className="flex flex-col gap-4 lg:gap-5 max-w-5xl mx-auto">
      ...
      <Card title="Edit Profile" icon={
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="bg-gray-50/50 p-5 rounded-2xl border border-gray-100/60">
            <h3 className="text-sm font-bold text-gray-900 mb-4 pb-2 border-b border-gray-200/50 flex items-center gap-2">
              ...
              <div>
                ...
                <div className="relative">
                  <select name="monthly_volume" value={editForm.monthly_volume} onChange={onChange} 
                    className="w-full px-3.5 py-2.5 rounded-lg border border-gray-200 bg-white text-[#151e13] focus:border-[#085041] focus:ring-4 focus:ring-[#085041]/10 outline-none transition-all text-sm appearance-none cursor-pointer shadow-sm hover:border-gray-300"
                  >
        ...
        {/* Status Messages */}
        {success && (
          <div className="mt-4 p-3 rounded-lg bg-emerald-50 border border-emerald-100 text-emerald-700 text-sm flex items-center gap-3 font-medium">
            <span className="material-symbols-outlined text-[20px] text-emerald-500">check_circle</span>
            Your profile details have been updated successfully.
          </div>
        )}
        {error && (
          <div className="mt-4 p-3 rounded-lg bg-red-50 border border-red-100 text-red-600 text-sm flex items-center gap-3 font-medium">
        ...
        <div className="mt-5 pt-4 border-t border-gray-100 flex justify-end">
          <button 
            onClick={onSave} 
            disabled={saving} 
            className={`w-full md:w-auto px-6 py-2.5 rounded-lg font-bold text-white text-sm transition-all flex justify-center items-center gap-2 ${
              saving 
      ...
      <Card title="Security & Password" icon={
        ...
        <div className="flex flex-col md:flex-row gap-5 items-start">
          <div className="flex-1 max-w-md w-full bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
            <h3 className="text-sm font-bold text-gray-900 mb-4 pb-2 border-b border-gray-100 flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#085041]"></span>
              Update Password
            </h3>
            ...
            <div className="mt-5 pt-4 border-t border-gray-100">
              <button 
                onClick={pwOnSave} 
                disabled={pwSaving} 
                className={`w-full px-6 py-2.5 rounded-lg font-bold text-white text-sm transition-all flex justify-center items-center gap-2 ${
                  pwSaving 
                    ? 'bg-[#085041]/70 cursor-not-allowed' 
                    : 'bg-[#085041] hover:bg-[#063d31] shadow-lg shadow-[#085041]/20 hover:shadow-[#085041]/30 hover:-translate-y-0.5 cursor-pointer'
                }`}
          ...
          <div className="flex-1 bg-blue-50/50 p-5 rounded-2xl border border-blue-100/50 mt-4 md:mt-0 hidden md:block">
